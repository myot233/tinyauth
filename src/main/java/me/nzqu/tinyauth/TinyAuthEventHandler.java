...
public class TinyAuthEventHandler {
    ...
    public static void clonePlayer(PlayerEvent.Clone event) {
        ...
        clone.loginDelayTick = original.loginDelayTick;
        clone.loginHistory = original.loginHistory;
        clone.allowedIPs = original.allowedIPs;
        clone.PlayerGameMode = original.PlayerGameMode;
    }
